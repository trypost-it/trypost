...
const variants = computed(() =>
    isPage.value
        ? [
              {
                  value: ContentType.LinkedInPagePost,
                  labelKey: 'posts.form.linkedin.variant.post',
              },
              {
                  value: ContentType.LinkedInPageCarousel,
                  labelKey: 'posts.form.linkedin.variant.carousel',
              },
          ]
        : [
              {
                  value: ContentType.LinkedInPost,
                  labelKey: 'posts.form.linkedin.variant.post',
              },
              {
        ...
        >
            ...
            <div class="space-y-2">
                <p
                    class="text-[11px] font-black tracking-widest text-foreground/60 uppercase"
                >
                    {{ $t('posts.form.linkedin.variant_label') }}
                </p>
