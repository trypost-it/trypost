...
<template>
    <div class="bg-white dark:bg-[#101010] rounded-xl overflow-hidden border border-gray-200 dark:border-gray-800">
        <!-- Thread Content -->
        <div class="p-4">
            <div class="flex gap-3">
                ...
                <div class="flex flex-col items-center">
                    ...
                    />
                    <div v-else class="h-9 w-9 rounded-full bg-gradient-to-br from-gray-700 to-gray-900 flex items-center justify-center text-white font-bold text-sm">
                        {{ socialAccount.display_name?.charAt(0) }}
                    </div>
                    <!-- Thread line -->
                    <div class="w-0.5 flex-1 bg-gray-200 dark:bg-gray-800 mt-2 min-h-[20px]" />
                </div>
                ...
                <div class="flex-1 min-w-0 pb-3">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <button class="p-1 hover:bg-gray-100 dark:hover:bg-gray-900 rounded-full">
                    ...
                    <!-- Media -->
                    <div v-if="media.length > 0" class="mt-2">
                        <div
                    ...
                    <div class="flex items-center gap-1 mt-3 -ml-2">
                        <button class="p-2 hover:bg-gray-100 dark:hover:bg-gray-900 rounded-full group">
                            <IconHeart class="h-5 w-5 text-gray-600 dark:text-gray-400 group-hover:text-red-500" />
                        </button>
                        <button class="p-2 hover:bg-gray-100 dark:hover:bg-gray-900 rounded-full group">
                            <IconMessageCircle class="h-5 w-5 text-gray-600 dark:text-gray-400 group-hover:text-blue-500" />
                        </button>
                        <button class="p-2 hover:bg-gray-100 dark:hover:bg-gray-900 rounded-full group">
                            <IconRepeat class="h-5 w-5 text-gray-600 dark:text-gray-400 group-hover:text-green-500" />
                        </button>
                        <button class="p-2 hover:bg-gray-100 dark:hover:bg-gray-900 rounded-full group">
                            <IconSend class="h-5 w-5 text-gray-600 dark:text-gray-400 group-hover:text-blue-500" />
                        </button>
                    </div>
        ...
        <div class="border-t border-gray-200 dark:border-gray-800 px-4 py-3 flex items-center justify-between bg-gray-50 dark:bg-gray-900/50">
            ...
            <label class="cursor-pointer p-2 rounded-full hover:bg-gray-200 dark:hover:bg-gray-800 transition-colors">
                <input
                    type="file"
                    accept="image/*,video/*"
                    multiple
